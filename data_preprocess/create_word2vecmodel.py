...
'''
def generate_w2vModel(decTokenFlawPath, w2vModelPath, size=30, alpha=0.008, window=5, min_alpha=0.0005, sg=1, hs=0, negative=7, iter=0):
    print("training...")
...
def main():
    dec_tokenFlaw_path = ['/home/zcg/VulDeeLocator/program_zcg/SARD/SARD/corpus_new/']

    for iter in [1, 3, 5, 10, 15]:
        w2v_model_path = "./w2v_model/wordmodel_min_iter"+str(iter)+"_new.model"
