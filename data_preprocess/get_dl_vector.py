...
def get_dldata(filepath, dlTrainCorpusPath, dlTestCorpusPath, split=0.8, seed=2018, batch_size=16):
    ...
    for i in num:
        ...
        f_train = open(dlTrainCorpusPath + "train_" + str(i)+ "_0819.pkl", 'wb')
    ...
    for i in num:
        ...
        f_test = open(dlTestCorpusPath + "test_" + str(i)+ "_0125.pkl", 'wb')
...
if __name__ == "__main__":
    ...
    CORPUSPATH = "/home/zcg/VulDeeLocator/program_zcg/SARD/SARD/corpus_new/"
    VECTORPATH = "/home/zcg/VulDeeLocator/src/data_preprocess/data/dl_input_new/"
    W2VPATH = "/home/zcg/VulDeeLocator/src/data_preprocess/w2v_model/wordmodel_min_iter5_new.model"
    ...
    VECTORPATH = "/home/zcg/VulDeeLocator/src/data_preprocess/data/dl_input_new/"
    dlTrainCorpusPath = "/home/zcg/VulDeeLocator/src/data_preprocess/data/dl_input_new/train_new/"
    dlTestCorpusPath = "/home/zcg/VulDeeLocator/src/data_preprocess/data/dl_input_new/test_new/"
