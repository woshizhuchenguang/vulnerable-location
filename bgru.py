...
def build_model(maxlen, vector_dim, layers, dropout):
    ...
    #model.compile(loss='binary_crossentropy', optimizer='adamax', metrics=['TP_count', 'FP_count', 'FN_count', 'precision', 'recall', 'fbeta_score'])zcg 这行报错
...
def main(traindataSet_path, testdataSet_path, realtestpath, weightpath, resultpath, batch_size, maxlen, vector_dim, layers, dropout):#多了realtestpath
    print("Loading data...")
...
if __name__ == "__main__":
    ...
    traindataSetPath ="/home/zcg/VulDeeLocator/src/1/"
    testdataSetPath = "/home/zcg/VulDeeLocator/src/1/"
